...
<%
    ...
    String sql = "select id,title,name,leader,taskmember,time,priority,status from arctask where taskmember like '%"+myname+"%'";
...
<html>
    ...
    <body bgcolor="#FFD699">
        ...
        <form name="form1" method="post" action="delarc.jsp" onSubmit="return check();">
            ...
            <table align="center">      
                <tr>
                    <td><a href="arctable.jsp">Home Page</a><a> &nbsp;&gt;&nbsp;</a><span class="style1">Task Management</span></td>
                </tr>
                <tr>
                    ...
                    <td width="50%" class="l"><div align="right">
                            <% if ("y".equals(pass)) {%>
                            <input name="imageField" type="image" src="img/del3.jpg" width="150" height="30" onMouseOut="this.src = 'img/del3.jpg';" onMouseOver="this.src = 'img/del4.jpg';" alt="delete forever"/>
