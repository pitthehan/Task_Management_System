...
<%
    ...
    String sql = "select id,title,name,leader,taskmember,time,priority,status from arctask order by id desc";
...
<html>
    ...
    <body bgcolor="#FFD699">
     ...
     <div align="center"><img src="img/archived.jpg"  alt="header" class="header" /></div>
            ...
            <div align="center"><% if ("y".equals(pass)) {%>Please manage your archived tasks <% }%></div>
            <div align="center"><% if ("y".equals(pass)) {%><a href="index.jsp">Go to manage existing tasks</a><% }%></div>
            <div align="center"><% if ("y".equals(pass)) {%><a href="logout.jsp">log out from administrator mode</a> <% }%></div>
               <br>
               
          <form name="form0" method="post" action="searcharc.jsp" >
         <table align="center">
                <tr>                 
          ...
          <form name="form1" method="post" action="delarc.jsp" onSubmit="return check();">
                          
            <table align="center">
                <tr>
                    <td><a href="arctable.jsp">Home Page of Archived Tasks</a><a>&nbsp;&gt;&nbsp;</a><span class="style1">Archived Tasks Table</span></td>
                </tr>
                <tr> 
                    <td width="50%" class="l">Current Page: <%=pages%>&nbsp;&nbsp;&nbsp; Totally <%=pa%> Pages
                        <% if (pages > 1) {%>
                        <a href="index.jsp">Home Page</a> <a href="index.jsp?pages=<%=pages - 1%>">Previous Page</a> <% }
                            if (pages < pa) {%>
                        <a href="index.jsp?pages=<%=pages + 1%>">Next Page</a> <a href="index.jsp?pages=<%=pa%>">End Page</a>   <% }%></td>
                    <td width="50%" class="l"><div align="right"><% if ("y".equals(pass)) {%><input name="imageField" type="image" alt="delete forever" src="img/del3.jpg" width="150" height="30" border="0" onMouseOut="this.src = 'img/del3.jpg';" onMouseOver="this.src = 'img/del4.jpg';" />
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td><div align="center"><a href="showarctable.jsp?id=<%=taskdb.getString(1)%>" target="_blank"><%=taskdb.getString(2)%></a></div></td>
                                                        ...
                                                        if (l == pages) {%><font color="#FF0000">Page <%=l%></font>&nbsp;<% } else {%><a href="index.jsp?pages=<%=l%>">Page <%=l%></a>&nbsp;<% }
                                                            ...
                                                            for (int m = pages - 3; m < pages + 3; m++) {
                                                                if (m == pages) {%><font color="#FF0000">Page <%=m%></font>&nbsp;<% } else {%><a href="index.jsp?pages=<%=m%>">Page <%=m%></a>&nbsp;<% }
                                                                    ...
                                                                    }%>&nbsp;&nbsp;&nbsp;Totally <%=pa%> Pages &nbsp;&nbsp;&nbsp;There are <%=count%> archived tasks&nbsp;&nbsp;&nbsp;</div></td>
                </tr>
            </table>
                 <br>
        </form>
